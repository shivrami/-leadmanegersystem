...
const ConvertedLead = () => {
  ...
  const fetchLeads = async () => {
    try {
     ...
     // setLeads(data);
     setLeads(data.filter(lead => lead.leadStatusName === 'Converted')); 
    } catch (error) {
                      ...
                      <table id="basic-datatables" className="display table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <th><i class="fas fa-share-alt"></i> Lead Source</th>
                            <th><i class="fas fa-check-circle"></i> Lead Status</th>
                            <th><i class="fas fa-book"></i> Course</th>
                            <th><i class="fas fa-phone"></i> Contact</th>
                            <th><i class="fas fa-calendar"></i> Lead Date</th>
                            <th>Action</th>
                          </tr>
                        </thead>
